...
export const projects: Project[] = [
  {
    ...
    description: 'A full-featured e-commerce platform with a custom CMS for a fashion retailer.',
  ...
  },
  {
    ...
    description: 'A secure mobile banking application for a new-age fintech startup.',
  ...
  },
  {
    ...
    description: 'A real-time analytics dashboard for a B2B SaaS company.',
    technologies: ['React', 'D3.js', 'WebSocket', 'Google Cloud'],
    imageId: 'project-1',
  },
];
...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: 'Learn how incorporating design thinking principles into your development workflow can lead to better, more user-centric products.',
